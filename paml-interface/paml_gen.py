...
# Generating the commands in the job file.
    ...
    if args.model == "m8":
        import lib.m8 as m8;
        m8.generate(args.input, tree_input, args.genetrees, anc_recon_setting, args.path, args.output, outfile);
    if args.model == "m8a":
        import lib.m8a as m8a;
        m8a.generate(args.input, tree_input, args.genetrees, anc_recon_setting, args.path, args.output, outfile);
