############################################################
# Functions for the beta (M7) and beta+omega (M8) models from codeml.
# Running as a site model testing for positive selection (model = 0, compare M7 and M8 with LRT)
# 10.2021 - EK modifying Gregg's M1 script
############################################################
