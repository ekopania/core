############################################################
# Functions for the M1a model from codeml.
# 03.2021
############################################################
...
def parse(indir, features, outfile, pad):
    ...
    if features:
        headers = ["file","id","chr","start","end","lnl","k","clade","clade dn/ds","clade dn","clade ds"];
    else:
        headers = ["file","lnl","k","clade","clade dn/ds","clade dn","clade ds"];
    ...
    for d in os.listdir(indir):
        ...
        for line in open(cur_codeml_file):
            ...
            # These lines report the branch specific results
